    ...
    class WHSM_Shipping_Method_Page
    {
        ...
        public static function whsmsmp_register_post_type()
        {
            register_post_type( self::post_type, array(
                ...
                'capabilities'    => array(
                'edit_post'          => 'edit_hide_shipping',
                'read_post'          => 'read_hide_shipping',
                'delete_post'        => 'delete_hide_shipping',
                'edit_posts'         => 'edit_hide_shipping',
                'edit_others_posts'  => 'edit_hide_shipping',
                'publish_posts'      => 'edit_hide_shipping',
                'read_private_posts' => 'edit_hide_shipping',
            ),
            ) );
        }
