...
if ( ! function_exists( 'storefront_site_branding' ) ) {
	...
	function storefront_site_branding() {
		...
		<a href="/"><img class="logo" src="https://zooviki.eu/wp-content/uploads/2020/05/logo-zoo.png" alt="Зоомагазин и Зооаптека Вики"></a>	<?php storefront_site_title_or_logo(); ?>
		</div>
		<?php
	}
}
...
/********************* */
if ( ! function_exists( 'storefront_social' ) ) {
	/**
	 * Display social links
	 */
	function storefront_social() {
		echo '<div class="social">';	
			echo '<a href="https://www.facebook.com/ZooViki" target="_blank" rel="noopener">Facebook</a> | ';
			echo '<a href="https://www.instagram.com/zooviki.eu/" target="_blank" rel="noopener">Instagram</a>';		
			echo '</div>';	
